        ...
        <div className={classes.root}>
            <div>
                ...
                <Tooltip title="Twitter">
                    <IconButton rel="noreferrer" href="https://twitter.com/siddiqafraaz" target="_blank" className={classes.icon} size="small" color="secondary">
                        <Twitter />
                    </IconButton>
                </Tooltip>
                <Tooltip title="Instagram">
                    <IconButton rel="noreferrer" href="https://www.instagram.com/siddiqafraaz/" target="_blank" className={classes.icon} size="small" color="secondary">
                        <Instagram />
                    </IconButton>
                </Tooltip>
                <Tooltip title="LinkedIn">
                    <IconButton rel="noreferrer" href="https://www.linkedin.com/in/siddiqafraaz" target="_blank" className={classes.icon} size="small" color="secondary">
                        <LinkedIn />
                    </IconButton>
                </Tooltip>
                <Tooltip title="Mail">
                    <IconButton href="mailto:siddiqafraaz@gmail.com" className={classes.icon} size="small" color="secondary">
                        <Mail />
                    </IconButton>
                </Tooltip>
            </div>
